				...
				if(!data){
				   data=[];
			    	...
			    	for(var i=0;i<data.length;i++){
			    		...
			    		var aid=item.aid;
					var curl='/vv/dm/couponClick.php?aid='+aid+"&couponAmount="+couponAmount+"&minLimitPrice="+minLimitPrice+"&t=";
	...
	function recommendPut (sdata,flag) {
         ...
         console.log("wWidth:"+wWidth)
				...
				if(flag==3){ 
		    			aHref= "/jd/m/myJdJump.php?f=vhis&action=jdJump&skuId="+itemId;
		    			
		    		}else{
		    		
				    //	aHref="/data/pub/jump.php?f=vhis&hasCoupon=1&iid="+itemId;	
		    	            aHref="/vv/dm/goCorr.php?f=vhis&iid="+itemId;	
                               }
