				...
				if(!data){
				   data=[];
			    	...
			    	for(var i=0;i<data.length;i++){
			    		...
			    		var aid=item.aid;
					var curl='http://go.hispri.com/vv/dm/couponClick.php?aid='+aid+"&couponAmount="+couponAmount+"&minLimitPrice="+minLimitPrice+"&t="+preudParam;
			    	...
			    	if(isTaoke){
						...
						$locGoUrl="http://go.hispri.com/go/link.php?id="+sdata.lid+"&type=jd"+preudParam;
						 $("#golinkId").attr("href",$locGoUrl);

                                        }else  if("tao"==sdata.type&&sdata.lid){
                                                $locGoUrl="http://go.hispri.com/go/jump.php?id="+sdata.lid+"&type=tb"+preudParam;
                                                 $("#golinkId").attr("href",$locGoUrl);
  ...
  if(wWidth<400){
   isWap=1;
				...
				if(flag==3){ 
		    			aHref= "http://go.hispri.com/jd/m/myJdJump.php?f=vhis&action=jdJump&skuId="+itemId+preudParam;
		    			
		    		}else{
		    		
				    //	aHref="/data/pub/jump.php?f=vhis&hasCoupon=1&iid="+itemId;	
		    	            aHref="http://go.hispri.com/vv/dm/goCorr.php?f=vhis&iid="+itemId+preudParam;	
                               }
